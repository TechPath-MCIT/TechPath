 ...
 *     description: Hit once, right after Clerk's sign-in/sign-up redirect (via fallbackRedirectUrl
 *       on the SignIn/SignUp components). Idempotently upserts a User row keyed on clerkId, then
 *       redirects on to the app's normal landing route.
 *     responses:
 *       302:
